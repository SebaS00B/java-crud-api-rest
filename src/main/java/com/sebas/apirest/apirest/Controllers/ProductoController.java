package com.sebas.apirest.apirest.Controllers;
...
import com.sebas.apirest.apirest.Repositories.ProductoRepository;
...
public class ProductoController {
    ...
    public String productoDelete (@PathVariable Long id){
        ...
        return "El producto con el "+id+" fue eliminado";
    }
}
